...
export function getTools(): Tool[] {
  return [
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          view: { type: 'string', enum: ['full', 'summary', 'compact'], description: 'Response view' },
          format: { type: 'string', enum: ['json', 'toon-r', 'toon-d'], description: 'Response format' },
          entry_limit: { type: 'number', description: 'Compact entries limit' },
          task_limit: { type: 'number', description: 'Compact tasks limit' },
        },
        required: ['id'],
      },
    },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          view: { type: 'string', enum: ['full', 'summary', 'compact'], description: 'Response view' },
          format: { type: 'string', enum: ['json', 'toon-r', 'toon-d'], description: 'Response format' },
          max_items: { type: 'number', description: 'Compact result item budget' },
          max_chars: { type: 'number', description: 'Compact result char budget' },
        },
        required: ['project_id'],
      },
    },
    ...
    {
      name: 'entry-batch-get',
      description: 'Gets multiple derived compact entries by ID',
      inputSchema: {
        type: 'object' as const,
        properties: {
          entry_ids: { type: 'array', items: { type: 'string' }, description: 'Entry IDs' },
          format: { type: 'string', enum: ['json', 'toon-r', 'toon-d'], description: 'Response format' },
          max_items: { type: 'number', description: 'Compact result item budget' },
          max_chars: { type: 'number', description: 'Compact result char budget' },
        },
    ...
    },
    {
      ...
      description: 'Gets derived compact summary for an SDD entry',
      inputSchema: {
        type: 'object' as const,
        properties: {
    ...
    {
      name: 'memory-facts-get',
      description: 'Gets derived compact memory facts',
      inputSchema: {
        type: 'object' as const,
        properties: {
